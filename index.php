...
<head>
        ...
        <title>Incrivel LMS - Online Course </title>
    ...
    color: #da0b59 !important;
    font-family:'Open Sans', sans-serif;">INCRIVEL LMS</h2>
							</a>
			...
			<!-- ============================ Hero Banner  Start================================== -->
			<div class="image-cover hero_banner shadow rlt" style="background:rgba(254, 65, 53,0.1);">
				<div class="container">
					<!-- Type -->
					<div class="row align-items-center">
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="banner-search-2 transparent">
								<h1 class="big-header-capt cl_2 mb-0">Study Beyond<br><span>The Classroom</span></h1>
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="circle_flixio">
                                <img class="img-fluid" src="assets/img/circle-6.png" alt="">
                            </div>
							<div class="flixio">
                                <img class="img-fluid" src="assets/img/st-3.png" alt="">
                            </div>
						</div>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<div class="breadcrumbs-wrap">
								<h2 class="breadcrumb-title">Get the <span class="theme-cl">INCRIVEL LMS</span> advantage</h2>
						...
						<div class="col-lg-4 col-md-4 col-sm-12">
							<div class="articles_grid_style">
								<div class="articles_grid_thumb">
									<img src="assets/img/b-3.jpg" class="img-fluid" alt="" />
								</div>
								...
								<div class="articles_grid_caption">
									...
									<div class="articles_grid_author">
										...
										<h4>Chat with educators, ask questions, answer live polls, and get your doubts cleared - all while the class is going on</h4>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="articles_grid_style">
								...
								<div class="articles_grid_caption">
									...
									<div class="articles_grid_author">
										...
										<h4>Learning isn't just limited to classes with our practice section, mock tests and lecture notes shared as PDFs for your revision</h4>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="articles_grid_style">
								...
								<div class="articles_grid_caption">
									...
									<div class="articles_grid_author">
										...
										<h4>One subscription gets you access to all our live and recorded classes to watch from the comfort of any of your devices
								...
								<div class="singles_items">
									<div class="education_block_grid style_2">
										...
										<div class="education_block_thumb n-shadow">
											<a href="#"><img src="assets/img/upsc.jpg" class="img-fluid" alt=""></a>
										</div>
										
										<div class="education_block_body">
											<h4 class="bl-title"><a href="#">Crack UPSC CSE - GS with
India's largest learning platform</a></h4>
										</div>
										...
										<div class="education_block_footer">
											<div class="education_block_author">
												<div class="path-img"><a href="#"><img src="assets/img/user-1.jpg" class="img-fluid" alt=""></a></div>
								...
								<div class="singles_items">
									<div class="education_block_grid style_2">
										...
										<div class="education_block_thumb n-shadow">
											<a href="#"><img src="assets/img/co-2.jpg" class="img-fluid" alt=""></a>
										</div>
										
										<div class="education_block_body">
											<h4 class="bl-title"><a href="#">Crack IIT JEE with
India's largest learning platform</a></h4>
										</div>
										...
										<div class="education_block_footer">
											<div class="education_block_author">
												<div class="path-img"><a href="#"><img src="assets/img/user-2.jpg" class="img-fluid" alt=""></a></div>
												<h5><a href="#">Teacher name</a></h5>
											</div>
								...
								<div class="singles_items">
									<div class="education_block_grid style_2">
										...
										<div class="education_block_thumb n-shadow">
											<a href="#"><img src="assets/img/co-3.jpg" class="img-fluid" alt=""></a>
										</div>
										
										<div class="education_block_body">
											<h4 class="bl-title"><a href="#">Crack NEET UG with
India's largest learning platform</a></h4>
										</div>
										...
										<div class="education_block_footer">
											<div class="education_block_author">
												<div class="path-img"><a href="#"><img src="assets/img/user-3.jpg" class="img-fluid" alt=""></a></div>
												<h5><a href="#">Teacher name</a></h5>
											</div>
								...
								<div class="singles_items">
									<div class="education_block_grid style_2">
										...
										<div class="education_block_thumb n-shadow">
											<a href="#"><img src="assets/img/co-4.jpg" class="img-fluid" alt=""></a>
										</div>
										
										<div class="education_block_body">
											<h4 class="bl-title"><a href="#">The Complete Financial Analyst Course 2020</a></h4>
										</div>
										...
										<div class="education_block_footer">
											<div class="education_block_author">
												<div class="path-img"><a href="#"><img src="assets/img/user-4.jpg" class="img-fluid" alt=""></a></div>
												<h5><a href="#">Litha Maildick</a></h5>
											</div>
											<span class="education_block_time"><i class="ti-calendar mr-1"></i>1 days ago</span>
										</div>
								...
								<div class="singles_items">
									<div class="education_block_grid style_2">
										...
										<div class="education_block_thumb n-shadow">
											<a href="#"><img src="assets/img/co-5.jpg" class="img-fluid" alt=""></a>
										</div>
										
										<div class="education_block_body">
											<h4 class="bl-title"><a href="#">PMP Exam Prep Seminar - PMBOK Guide 6</a></h4>
										</div>
										...
										<div class="education_block_footer">
											<div class="education_block_author">
												<div class="path-img"><a href="#"><img src="assets/img/user-5.jpg" class="img-fluid" alt=""></a></div>
												<h5><a href="#">Chrish Gyle</a></h5>
											</div>
								...
								<div class="singles_items">
									<div class="education_block_grid style_2">
										...
										<div class="education_block_thumb n-shadow">
											<a href="#"><img src="assets/img/co-6.jpg" class="img-fluid" alt=""></a>
										</div>
										
										<div class="education_block_body">
											<h4 class="bl-title"><a href="#">Tableau 2020 A-Z:Hands-On Tableau Training For Data Science!</a></h4>
										</div>
										...
										<div class="education_block_footer">
											<div class="education_block_author">
												<div class="path-img"><a href="#"><img src="assets/img/user-6.jpg" class="img-fluid" alt=""></a></div>
												<h5><a href="#">Shilpa Shekh</a></h5>
											</div>
					...
					<div class="row justify-content-center">
						<div class="col-lg-5 col-md-6 col-sm-12">
							<div class="sec-heading center">
								...
								<h2><span class="theme-cl">Popular</span> Category For Learn</h2>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="list_facts_wrap">
								<div class="sec-heading mb-3">
									<h2>Know about <span class="theme-cl">INCRIVEL</span> LMS platform</h2>
								</div>
							...
							<div class="arrow_slide three_slide-dots arrow_middle">
								...
								<div class="singles_items">
									<div class="education_block_grid">
										...
										<div class="education_block_body">
											<h4 class="bl-title"><a href="#">Tableau for Beginners: Get CA Certified, Grow Your Career</a></h4>
								...
								<div class="singles_items">
									<div class="education_block_grid">
										...
										<div class="education_block_body">
											<h4 class="bl-title"><a href="#">The Complete Business Plan Course (Includes 50 Templates)</a></h4>
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore. </p>
										</div>
								...
								<div class="singles_items">
									<div class="education_block_grid">
										...
										<div class="education_block_body">
											<h4 class="bl-title"><a href="#">An Entire MBA in 1 Course:Award Winning Business School Prof</a></h4>
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore. </p>
										</div>
										...
										<div class="education_block_footer">
											<div class="education_block_author">
												<div class="path-img"><a href="#"><img src="assets/img/user-3.jpg" class="img-fluid" alt=""></a></div>
												<h5><a href="#">Dhananjay Preet</a></h5>
											</div>
								...
								<div class="singles_items">
									<div class="education_block_grid">
										...
										<div class="education_block_thumb">
											<a href="#"><img src="assets/img/course-4.jpg" class="img-fluid" alt=""></a>
								...
								<div class="singles_items">
									<div class="education_block_grid">
										...
										<div class="education_block_thumb">
											<a href="#"><img src="assets/img/course-5.jpg" class="img-fluid" alt=""></a>
								...
								<div class="singles_items">
									<div class="education_block_grid">
										...
										<div class="education_block_thumb">
											<a href="#"><img src="assets/img/course-6.jpg" class="img-fluid" alt=""></a>
			...
			<!-- ============================ Footer Start ================================== -->
				...
				<footer>
    <article>
        <div class='container pt50 pb50'><div class='row'><div class='col-md-3 col-sm-3 col-xs-12'><h3 class='ftr-head mt-xs-20'>Company</h3>
		<ul class='list-unstyled footer-txt'><li><a href='../'>Home</a></li>
		<ul class='list-unstyled footer-txt'><li><a href='../about'>About us</a></li>
		<li><a href='../careers'>Careers</a></li>
		<li><a href='../contact'>Contact Us</a></li>
</ul></div>
<div class='col-md-3 col-sm-3 col-xs-12'><h3 class='ftr-head mt-xs-20'>Services</h3>
<ul class='list-unstyled footer-txt'><li><a href='../webdesigning' target=_blank>Web Designing</a></li>
<li><a href='../softwaredevelopment' target=_blank>Software Development</a></li>
<li><a href='../logodesigning' target=_blank>Logo Designing</a></li>
<li><a href='../hrrecruiting' target=_blank>HR Recruiting</a></li>
<li><a href='../erpsolutions' target=_blank>ERP Solutions</a></li>
<li><a href='../mobileappdevelopment' target=_blank>Mobile App Development</a></li>
<li><a href='../digitalmarketing' target=_blank>Digital Marketing</a></li>
</ul></div>
<div class='col-md-3 col-sm-3 col-xs-12'><h3 class='ftr-head mt-xs-20'> </h3>
<ul class='list-unstyled footer-txt'><li><a href='../php' target=_blank>PHP</a></li>
<li><a href='../businessconsulting' target=_blank>Business Consulting</a></li>
<li><a href='../blockchain' target=_blank>Blockchain Services</a></li>
<li><a href='../conversions' target=_blank>Conversions</a></li>
<li><a href='../internetmarketing' target=_blank>Internet Marketing</a></li>
<li><a href='../dataanalytics' target=_blank>Data Analytics</a></li>
<li><a href='../testing' target=_blank>Testing Services</a></li>
</ul></div>

<div class='col-md-3 col-sm-12 col-xs-12'><h3 class='ftr-head mt-xs-20'>Connect with us</h3><ul class='list-inline d-flex footer-txt'>
<li class="mx-1"><a title='Twitter' target='_blank' href="https://twitter.com/incrivel_tech"><svg width='16' height='16'>
<image xlink:href='twitter.svg' src='twitter.png' width='16' height='16'/></svg></a></li>
<li class="mx-n3"><a title='Facebook' target='_blank' href="https://www.facebook.com/incrivel.in"><svg width='16' height='16'>
<image xlink:href='facebook.svg' src='facebook.png' width='16' height='16'/></svg></a></li>

<li><a title='Instagram' target='_blank' href="https://www.instagram.com/incrivel.tech/"><svg width='16' height='16'>
<image xlink:href='instagram.png' src='instagram.png' width='16' height='16'/></svg></a></li>

<li><a title='Linkedin' target='_blank' href="https://www.linkedin.com/company/incrivel-tech/"><svg width='16' height='16'>
<image xlink:href='linkedin.png' src='linkedin.png' width='16' height='16'/></svg></a></li>



</ul></div></div></div>
        <div class='container-fluid ptb15 bg-white'><div class='container'>
		<div class='row'><div class='col-md-8 col-sm-7 col-xs-12'><p class='mb0'>Copyright © 2020 Incrivel Technologies</p></div><div class='col-md-4 col-sm-5 col-xs-12'><div class='pull-right pull-left-xs mt-xs-20'>
